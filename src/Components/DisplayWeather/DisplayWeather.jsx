...
const DisplayWeather = () =>{
    ...
    const fetchWeather = async (city) =>{
        ...
        const data = await fetch(
            `https://api.openweathermap.org/data/2.5/weather?q=${city}&APPID=e7d72914a2460d8932965e257ed0a41f`
        );
        ...
        if(response.coord){
            ...
            const uvIndexUrl = `https://api.openweathermap.org/data/2.5/uvi?lat=${lat}&lon=${lon}&APPID=e7d72914a2460d8932965e257ed0a41f`;
